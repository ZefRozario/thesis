...
After some discussion with FTAG the number of EVs to keep after truncation were settled on per flavour and are shown in table.~\ref{table:EV}. The question remains: if the number of EVs retained contain enough information to effectively encapsulate uncertainties evaluated thus far.
\begin{center}
\begin{table}[h!]
